...
alter table developers ALTER  column sex type varchar(200);

alter table skills ALTER  column language type varchar(200);

alter table skills ALTER  column level type varchar(200);